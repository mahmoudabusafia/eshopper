...
@section('code', '403')
@section('message')
    <a href="{{ route('admin.index') }}" style="display: flex; align-items: center"><p style="margin-left: 5px">{{__($exception->getMessage() ?: 'Forbidden')}}</p><span class="svg-icon svg-icon-primary svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
...
</svg></span> <span style="margin-left: 5px; color: #0685f6">Go Back</span></a>
@endsection
