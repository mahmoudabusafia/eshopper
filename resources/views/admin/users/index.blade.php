        ...
        <div class="modal-content">
            <form class="form" action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row ">
                        <label class="col-form-label col-lg-4">{{ __('Email') }}</label>
                        <div class="col-lg-8">
                            <input type="email"
                    ...
                    <div class="form-group row ">
                        <label class="col-form-label col-lg-4">{{ __('Phone Number') }}</label>
                        <div class="col-lg-8">
                            <input type="tel"
                    ...
                    <div class="form-group row ">
                        <label class="col-form-label col-lg-4">{{ __('Password') }}</label>
                        <div class="col-lg-8">
                            <input type="password"
                    ...
                    <div class="form-group row ">
                        <label class="col-form-label col-lg-4">{{ __('Confirm Password') }}</label>
                        <div class="col-lg-8">
                            <input type="password"
