...
{{--                                    <div class="form-group row ">--}}
{{--                                        <label class="col-form-label col-lg-3">{{ __('New Password') }}</label>--}}
{{--                                        <div class="col-lg-6">--}}
{{--                                            <input type="password"--}}
...
{{--                                    </div>--}}
{{--                                    <div class="form-group row ">--}}
{{--                                        <label class="col-form-label col-lg-3">{{ __('Confirm New Password') }}</label>--}}
{{--                                        <div class="col-lg-6">--}}
{{--                                            <input type="password"--}}
                                        ...
                                        <div class="col-9 col-form-label">
                                            <div class="checkbox-inline">
                                                <label class="checkbox">
                                                    <input type="radio" name="type" value="user" @if($user->type == 'user') checked @endif/>
                                                    <span></span>
                                                    User
                                                </label>
                                                <label class="checkbox">
                                                    <input type="radio" name="type" value="seller" @if($user->type == 'seller') checked @endif/>
                                                    <span></span>
                                                    Seller
                                                </label>
                                            </div>
